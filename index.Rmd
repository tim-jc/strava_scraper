...
### `r str_glue('Projected miles this year<br>({get_ytd_values("ytd_predicted_distance_mi")["pytd"]} pytd projected, {get_ytd_values("distance_mi")["pyr"]} py total)')`

```{r}
get_ytd_valuebox("ytd_predicted_distance_mi")
```
